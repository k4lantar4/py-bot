/**
 * Theme configuration for the 3X-UI Management System.
 * 
 * This module provides theme configurations for light and dark modes.
 */
...
const createShadow = (color) => {
  ...
  return {
    boxShadow: `0px 3px 5px -1px ${transparent}, 0px 6px 10px 0px ${alpha(
      color,
      0.12
    )}, 0px 1px 18px 0px ${alpha(color, 0.08)}`,
  };
};
