...
echo -e "3. Run the setup script: ${BLUE}chmod +x *.sh && ./setup.sh${NC}"
echo -e "4. Fix database initialization: ${BLUE}./fix_db_init.sh${NC}"
echo -e "5. Fix frontend issues: ${BLUE}./fix_frontend.sh${NC}"
echo -e "6. Fix Login component: ${BLUE}./fix_login.sh${NC}"
echo -e "7. Fix service issues: ${BLUE}./fix_services.sh all${NC}"
echo -e "8. Check and edit .env file if needed: ${BLUE}nano .env${NC}"
echo -e "9. Start all services: ${BLUE}./start_services.sh${NC}" 