...
echo -e "6. Fix service issues: ${BLUE}./fix_services.sh all${NC}"
echo -e "7. Check and edit .env file if needed: ${BLUE}nano .env${NC}"
echo -e "8. Start all services: ${BLUE}./start_services.sh${NC}" 